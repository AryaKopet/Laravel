...
<head>
    ...
    <title>Tambahkan Pesanan Anda</title>
                    ...
                    <div class="card-body">
                        <form action="{{ route('keranjangs.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label class="font-weight-bold mt-3">ID PENGGUNA</label>
                                ...
                                <label class="font-weight-bold mt-3">ID BARANG</label>
                                ...
                                <label class="font-weight-bold mt-3">QTY</label>
                                <input type="text" class="form-control @error('qty') is-invalid @enderror" name="qty" value="{{ old('qty') }}" placeholder="Masukkan Jumlah Pesanan">
                            </div>
